...
**This project is a fork of [Calmera' jsonschema](https://github.com/calmera/jsonschema), originally forked from [Alec Thomas' jsonschema](https://github.com/alecthomas/jsonschema).**
